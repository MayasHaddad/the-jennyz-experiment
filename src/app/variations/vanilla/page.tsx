...
export default function VanillaPage() {
  ...
  return (
    <div className="vanilla-theme h-screen bg-secondary text-foreground flex flex-col font-sans selection:bg-primary/30 overflow-hidden">
      {/* Top Header Bar - spans full width */}
      <header className="h-14 bg-secondary flex items-center px-4 flex-shrink-0">
        {/* Brand section */}
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <aside className="w-[240px] p-4 pt-2 hidden lg:flex flex-col bg-secondary">
          ...
          <div className="flex-1 overflow-y-auto space-y-0.5">
            <div className="flex items-center gap-3 px-3 py-2.5 text-card-foreground text-sm font-medium cursor-pointer border-l-2 border-card-foreground bg-card rounded-r-md">
          ...
          <div className="mt-auto pt-4">
            ...
            <div className="flex items-center gap-3 px-2">
              <div className="h-9 w-9 bg-muted rounded-md overflow-hidden">
                <Image src="/alex.png" alt="Alex D." width={36} height={36} className="h-full w-full object-cover" />
              </div>
        ...
        <main className="flex-1 overflow-y-auto bg-background shadow-md rounded-tl-2xl">
          <header className="flex justify-between items-center mb-8 sticky top-0 bg-background z-10 py-4 pt-8 px-4 -mt-4">
            ...
            <button className="text-sm font-medium text-primary flex items-center gap-2 hover:opacity-80 transition-opacity">
